...
public class CustomerPage extends BasePage {
	...
	public void createCustomerRecord(String custKey, String custCompany, String custContactName, String custPhoneNum,
		...
		elementUtil.clickWhenReady(custAddBtn, 5);
		...
		elementUtil.clickWhenReady(custSaveBtn, 15);
		//elementUtil.clickWhenReady(custAddBtn, 15);
		//elementUtil.waitForElementToBeVisible(header, 5);
		//elementUtil.doClick(custAddBtn);
	}
}